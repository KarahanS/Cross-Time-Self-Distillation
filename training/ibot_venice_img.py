...
from loader_wtvenice import DataAugmentationiBOT, WTVeniceFrameDataset
import wandb
...
def train_ibot(args):
    ...
    dataset = WTVeniceFrameDataset(
        clips_root=args.data_path,
        transform=transform,
        ...
        neigh_mim=args.neighbor_mim_mask,
...
def train_one_epoch(
    ...
    for it, (images, labels, mim_masks, nimages, nmim_masks) in enumerate(
        ...
        nmasks_global = nmim_masks[:G] if nmim_masks else []  # G MIM masks for neighbor
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):
            ...
            student_neighbor_global_cls, student_neighbor_local_cls = None, None
            if args.lambda_timeimg > 0:
                # TODO: this can be updated based on the existence of MIM mask flags
                student_neighbor_global_cls = student(nimages_global)[0]
            ...
            all_loss = ibot_loss(
                ...
                teacher_cls,
                teacher_patch,
                teacher_neighbor_cls,
                teacher_neighbor_patch,
